...
Una vez que en [el hito 0](https://github.com/cvillalonga/CC-23-24/new/master/hitos/0.Repositorio) el MVP creado es simplemente
...
Se recuerda que hay que seguir las recomendaciones presentadas en el [el hito
0](https://github.com/cvillalonga/CC-23-24/new/master/hitos/0.Repositorio.md)
sobre commits, issues y milestones.
...
De la forma
habitual, editando el fichero con un enlace al repo y un número de versión que se incrementará con cada hito y también con
