...
Una vez que en [el hito 0](./0.Repositorio.md) el MVP creado es simplemente
...
* A continuación tiene que haber HUs que establezcan las diferentes
  ...
  consultar
  [este tema](https://jj.github.io/curso-tdd/temas/dise%C3%B1o.html). En principio, en este hito no se requiere
